...
// 	kernelExp_RtlFreeAnsiString = 296,
	...
	kernelExp_MmResetLowestAvailablePages = 909,
	kernelExp_VeSetHandlers = 916,
	kernelExp_HalConfigureVeDevice = 917,
	kernelExp_XeCryptSha224Init = 918,
	kernelExp_XeCryptAesCreateKeySchedule = 919,
	kernelExp_XeCryptAesEncryptOne = 920,
	kernelExp_XeCryptAesDecryptOne = 921,
	kernelExp_XeCryptAesCbcEncrypt = 922,
	kernelExp_XeCryptAesCbcDecrypt = 923,
	kernelExp_XeCryptAesGcmInitialize = 924,
	kernelExp_XeCryptAesGcmUpdate = 925,
	kernelExp_XeCryptAesGcmFinalize = 926,
	kernelExp_XeCryptEccGetCurveParameters = 927,
	kernelExp_XeCryptEccEcdhGenerateKeypair = 928,
	kernelExp_XeCryptEccEcdhExponentiate = 929,
	kernelExp_XeCryptEccEcdsaGenerateSignature = 930,
	kernelExp_XeCryptEccEcdsaVerifySignature = 931,
} kernelExp_Enum;
