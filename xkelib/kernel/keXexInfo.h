...
#define XEX_HEADER_PRIVILEGE(priv)			(XEX_HEADER_FLAG(0x0300)+((priv&~0x1f)<<3)) // makes no sense.. privs 0-31
#define XEX_HEADER_PRIVILEGE2(priv)			(XEX_HEADER_FLAG(0x0301)+((priv&~0x1f)<<3)) // makes no sense.. privs 32+
